...
public class ReservationException extends Exception {
	...
	public static final int CODE_CANNOT_DELETE = 6;
	...
	private static final String MESSAGE_CANNOT_DELETE = "This reservation cannot be deleted (it may have been already consumed).";
	...
	public String getMessage() {
		...
		switch (code) {
			...
			case CODE_DB_CLOSE_ERROR:
				...
				break;
			case CODE_CANNOT_DELETE:
				result = MESSAGE_CANNOT_DELETE;
				break;
			default:
				result = "";
				break;
